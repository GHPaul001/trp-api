...
class AttributeTranslationsController extends Controller
{
    ...
    public function update(AttributeTranslationsRequest $request, AttributeTranslations $attribute_translations)
    {
      try {
          $response = $attribute_translations->update($request->validated());
